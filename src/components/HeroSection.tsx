...
// </motion.ul>
// <motion.button
// className="bg-[#1600ea] hover:bg-blue-500 rounded-sm text-white font-bold py-2 px-6 mt-4 sm:mt-0"
...
return (
<motion.section className="bg-[#070324] py-8 px-4 sm:py-12 sm:px-8">
<div className="flex flex-col-reverse sm:flex-row justify-around items-center text-white h-[455px] w-[95%]">
<div className="mt-8 sm:mt-16 text-center sm:text-left lg:mr-24 sm:ml-0 translate-x-[18px]">
<motion.h1
className="text-4xl font-Arimo font-normal sm:text-5xl lg:text-[60px] mb-4"
initial={{ opacity: 0, scale: 0.8 }}
